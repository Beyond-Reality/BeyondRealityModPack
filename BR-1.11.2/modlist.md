...
| [Embers](http://www.curseforge.com/projects/embers/) | 0.206 | Elucent<br/>AlexisMachina<br/>ShadowGamerXY<br/>werty1124 | Dwarven-style Magitech Mod |
| [Extra Bit Manipulation](http://www.curseforge.com/projects/extra-bit-manipulation/) | 1.11.2-3.0.5 | MolecularPhylo | Adds extra in-world bit manipulation to the Chisels & Bits mod. |
...
| [Forestry](http://forestry.sengir.net/) | 5.3.3.75 | SirSengir<br/>mezz | Trees, bees and more. |
...
| [Just Enough Items](https://github.com/mezz/JustEnoughItems) | 4.3.1.257 | mezz | Simple recipe and item helper. |
...
| [Shulkerbox](http://www.curseforge.com/projects/advanced-shulkerboxes/) | 1.1.1 | Max Henkel | Shulkerbox |
...
| [TorchMaster](http://www.curseforge.com/projects/torchmaster/) | 1.2.0.19 | xalcon | Adds a special torch which prevents mobs from spawning in a configurable range |
...
| [Unified Items](http://minecraft.curseforge.com/projects/unified-items) | 1.11.2-1.5.2-163 | chazwarp923 | Unified Items is a mod to centralize ore generation and items into one simple to use package. It is entirely modular by design and therefore only loads the necessary modules on runtime. |
...
| [Shadowfacts-Forgelin](http://www.curseforge.com/projects/shadowfacts-forgelin/) | 1.4.1 | shadowfactsmc | My fork of Emberwalker's Forgelin, with some sprinkles on top. |
