...
for woodType in woodTypes
{
  ...
  var stairWood = <Forestry:stairs>.definition.makeStack(woodType);
  var stairWoodFireproof = <Forestry:stairsFireproof>.definition.makeStack(woodType);
  var fenceWood = <Forestry:fences>.definition.makeStack(woodType);
  var fenceWoodFireproof = <Forestry:fencesFireproof>.definition.makeStack(woodType);

// Fix missing oredictionary

<ore:plankWood>.add(plankWood);
<ore:plankWood>.add(plankWoodFireproof);
<ore:plankWoodFireproof>.add(plankWoodFireproof);
<ore:logWood>.add(logWood);
<ore:logWood>.add(logWoodFireproof);
<ore:logWoodFireproof>.add(logWoodFireproof);
<ore:slabWood>.add(slabWood);
<ore:slabWood>.add(slabWoodFireproof);
<ore:slabWoodFireproof>.add(slabWoodFireproof);
<ore:stairWood>.add(stairWood);
<ore:stairWood>.add(stairWoodFireproof);
<ore:stairWoodFireproof>.add(stairWoodFireproof);
<ore:fenceWood>.add(fenceWood);
<ore:fenceWood>.add(fenceWoodFireproof);
<ore:fenceWoodFireproof>.add(fenceWoodFireproof);
